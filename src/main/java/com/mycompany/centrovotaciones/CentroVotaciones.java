...
public class CentroVotaciones {
    ...
    int opcion = 0;
     System.out.print("Ingrese contrasenia del administrador:");
        ...
        switch (opcion){
            case 1:
                com.mycompany.centrovotaciones.CentroVotaciones registrarUsuario = new com.mycompany.centrovotaciones.CentroVotaciones();
                registrarUsuario.registroUsuarios();
                break;
            case 2:
                com.mycompany.centrovotaciones.CentroVotaciones registraVotante = new com.mycompany.centrovotaciones.CentroVotaciones();
    ...
    public void registroUsuarios(){
        ...
        switch (opcion){
            case 1:
            com.mycompany.centrovotaciones.CentroVotaciones crearUsuario= new com.mycompany.centrovotaciones.CentroVotaciones();
            crearUsuario.crearUsuario();
            break;
            case 2 :
            com.mycompany.centrovotaciones.CentroVotaciones modificarUsuario = new com.mycompany.centrovotaciones.CentroVotaciones();
            modificarUsuario.modificarUsuario();
            break;
            case 3:
            com.mycompany.centrovotaciones.CentroVotaciones reiniciar = new com.mycompany.centrovotaciones.CentroVotaciones();
            reiniciar.reinicio();
            break;
        }
}
    ...
    public void crearUsuario(){
       try{
                    ...
                    bw.close();
                        ...
                        Logger.getLogger(CentroVotaciones.class.getName()).log(Level.SEVERE, null, ex);
                    }       
    }  
    
    public void modificarUsuario(){
        CentroVotaciones centroVotacion = new CentroVotaciones();
    ...
    public void reinicio(){
        ...
        CentroVotaciones centro = new CentroVotaciones();
    ...
    public void registroVotantes(){
        ...
        switch (opcion){
            case 1:
           com.mycompany.centrovotaciones.CentroVotaciones regisVotante = new com.mycompany.centrovotaciones.CentroVotaciones();
